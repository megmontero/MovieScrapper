...
class IMDBStorageManager():
    ...
    def __init__(self, dbfile="db/imdb_dataset"):
        ...
        self._movie_keys = ["id","@type","year", "title", "genre", "contentRating", 
                            "description", "datePublished", "keywords", "duration",
                            "rtng_all_v", "rtng_all_r","rtng_<18_v", "rtng_<18_r",
                            "rtng_18-29_v", "rtng_18-29_r", "rtng_30-44_v",
                            "rtng_30-44_r", "rtng_45+_v", "rtng_45+_r",
                            "rtng_males_v", "rtng_males_r","rtng_m<18_v", "rtng_m<18_r",
                            "rtng_m18-29_v", "rtng_m18-29_r", "rtng_m30-44_v",
                            "rtng_m30-44_r", "rtng_m45+_v", "rtng_m45+_r",
                            "rtng_females_v", "rtng_females_r","rtng_f<18_v", "rtng_f<18_r",
    ...
    def _write_csv_row(self, file_name,row, mode="a"):
        ...
        format_row = [('"' + r + '"') if isinstance(r, str) else str(r)  for r in row]
